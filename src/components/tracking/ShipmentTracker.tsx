          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md flex flex-col">
            ...
            <div className="p-6 flex flex-col items-center">
              <div className="mb-4 text-center">
                ...
                <p className="text-gray-700">View this location on Google Maps</p>
              </div>
              <button 
                onClick={() => openGoogleMapsInNewTab(selectedLocation)}
                className="w-full px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md flex items-center justify-center space-x-2"
              >
